...
int main() {
	...
	camera.LookAt(glm::vec3(0.0f, 15.0f, 35.0f), glm::vec3(0.0f, 0.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	...
	gep3d::Light* ambient_light = new gep3d::Light(glm::vec3(1.0f, 1.0f, 1.0f)); // Cor da luz ambiente
	// Cria uma luz direcional (ex: sol)
	gep3d::Light* directional_light = new gep3d::Light(
		glm::vec3(0.0f, -1.0f, -1.0f),	// Direção da luz
	...
	gep3d::Light* point_light = new gep3d::Light(
		glm::vec3(0.0f, 0.0f, -15.0f),	// Posição da luz
		glm::vec3(0.05f, 0.05f, 0.05f),    // Componente ambiente
		glm::vec3(1.0f, 1.0f, 1.0f),    // Componente difusa
		glm::vec3(0.4f, 0.4f, 0.4f),    // Componente especular
	...
	//paredes
	gep3d::Object* parede1 = new gep3d::Object("Parede1", "", nullptr, tablerrenderer, 8.0f, 1.0f, -15.0f, 0.0f, 90.0f, 0.0f, 16.0f, 5.0f, 1.0f);
	gep3d::Object* parede2 = new gep3d::Object("Parede2", "", nullptr, tablerrenderer, -8.0f, 1.0f, -15.0f, 0.0f, 90.0f, 0.0f, 16.0f, 5.0f, 1.0f);
	gep3d::Object* parede3 = new gep3d::Object("Parede3", "", nullptr, tablerrenderer, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f, 0.0f, 8.5f, 5.0f, 1.0f);
	gep3d::Object* parede4 = new gep3d::Object("Parede4", "", nullptr, tablerrenderer, 0.0f, 1.0f, -31.0f, 0.0f, 0.0f, 0.0f, 8.5f, 5.0f, 1.0f);
	...
	game.AddObject(parede1);
	game.AddObject(parede2);
	game.AddObject(parede3);
	game.AddObject(parede4);
